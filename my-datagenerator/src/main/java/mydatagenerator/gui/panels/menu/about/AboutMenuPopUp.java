...
/**
 * The pop-up window showed when the user click on the "About --> About" entry in the menu bar
 *
 */
public class AboutMenuPopUp extends JDialog{
	...
	public AboutMenuPopUp() {	
			...
			tabbedPane.addTab("Application License", new JScrollPane(new LicensePanel()));
			tabbedPane.addTab("Third part License", new JScrollPane(new ThirdPartLicense()));	
